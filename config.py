...
BOT_TOKEN = getenv("7340381347:AAFfVgtVNSyFCX-XNJav0gDGbRdXUODDRXA")
...
LOG_GROUP_ID = int(getenv("-1002620193757", None))

# Get this value from @MissRose_Bot on Telegram by /id
OWNER_ID = int(getenv("7218327869", None))

## Fill these variables if you're deploying on heroku.
# Your heroku app name
HEROKU_APP_NAME = getenv("XezerMusicRobot")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Xezer_Botlar")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Xezer_Destek")
