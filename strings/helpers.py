HELP_1 = """<b><u>ᴀᴅᴍɪɴ әᴍʀʟәʀɪ :</b></u>

ᴊᴜsᴛ ᴀᴅᴅ <b>ᴄ</b> ɪɴ ᴛʜᴇ sᴛᴀʀᴛɪɴɢ ᴏғ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅs ᴛᴏ ᴜsᴇ ᴛʜᴇᴍ ғᴏʀ ᴄʜᴀɴɴᴇʟ.


/pause : ᴄᴀʀɪ ʏᴀʏɪᴍɪ ᴅᴀʏᴀɴᴅıʀ.

/resume : ᴅᴀʏᴀɴᴅıʀıʟᴍış ʏᴀʏıᴍı ᴅᴀᴠᴀᴍ ᴇᴛ.

/skip : ᴄᴀʀɪ ʏᴀʏıᴍı ᴋᴇç ᴠə ɴᴏvʙᴇᴛɪ ᴍᴀʜɴıɴı ʏᴀʏıᴍᴀ ʙᴀşʟᴀ.
/end ᴏʀ /stop : ᴄᴀʀɪ ʏᴀʏıᴍı ᴅᴀʏᴀɴᴅıʀ.

/player : İɴᴛᴇʀᴀᴋᴛɪᴠ ᴏʏᴜɴᴄᴜ ᴘᴀɴᴇʟɪ ᴀʟ.

/queue : ᴍᴀʜɴıʟᴀʀıɴ sɪʏᴀʜısıɴı ɢösᴛəʀ.
"""

HELP_2 = """
<b><u>ᴀᴜᴛᴏʀɪᴢᴀsɪʏᴀ ɪsᴛɪғᴀᴅəçɪʟəʀ :</b></u>

ᴀᴜᴛʜ ᴜsᴇʀs ᴄᴀɴ ᴜsᴇ ᴀᴅᴍɪɴ ʀɪɢʜᴛs ɪɴ ᴛʜᴇ ʙᴏᴛ ᴡɪᴛʜᴏᴜᴛ ᴀᴅᴍɪɴ ʀɪɢʜᴛs ɪɴ ᴛʜᴇ ᴄʜᴀᴛ.

/auth [ᴜsᴇʀɴᴀᴍᴇ/ᴜsᴇʀ_ɪᴅ] : ʙᴏᴛᴜɴ ᴀᴜᴛᴏʀɪᴢᴀsɪʏᴀ ʟɪsᴛᴇsɪɴə ɪsᴛɪғᴀᴅəçɪ ᴇʟᴀᴠə ᴇᴛ.
/unauth [ᴜsᴇʀɴᴀᴍᴇ/ᴜsᴇʀ_ɪᴅ] : ᴀᴜᴛᴏʀɪᴢᴀsɪʏᴀ ɪsᴛɪғᴀᴅəçɪʟəʀɪ sɪʏᴀʜısıɴᴅᴀɴ ʙɪʀ ɪsᴛɪғᴀᴅəçɪɴɪ sɪʟ.
/authusers : ɢʀᴜᴘ ᴀᴜᴛᴏʀɪᴢᴀsɪʏᴀ ɪsᴛɪғᴀᴅəçɪʟəʀɪɴ sɪʏᴀʜısını ɢösᴛəʀ.
"""
...
/blacklistchat [ᴄʜᴀᴛ ɪᴅ] : ᴄʜᴀᴛɪɴ ǫᴀʀᴀ sɪʏᴀʜɪsɪ
/whitelistchat [ᴄʜᴀᴛ ɪᴅ] : ᴄʜᴀᴛɪɴ ᴀğ sɪʏᴀʜɪsɪ
/blacklistedchat : ᴄʜᴀᴛɪɴ ǫᴀʀᴀ sɪʏᴀʜɪsɪɴᴀ ʙᴀx.
"""

HELP_5 = """
<u><b>ǫᴀᴅᴀğᴀʟı ᴜsᴇʀʟəʀ:</b></u> [ᴏɴʟʏ ғᴏʀ sᴜᴅᴏᴇʀs]

sᴛᴀʀᴛs ɪɢɴᴏʀɪɴɢ ᴛʜᴇ ʙʟᴀᴄᴋʟɪsᴛᴇᴅ ᴜsᴇʀ, sᴏ ᴛʜᴀᴛ ʜᴇ ᴄᴀɴ'ᴛ ᴜsᴇ ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅs.

/block [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴩʟʏ ᴛᴏ ᴀ ᴜsᴇʀ] : ɪsᴛɪғᴀᴅəçɪɴɪ ʙᴏᴛᴅᴀɴ ʙʟᴏᴋʟᴀ
/unblock [ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ʀᴇᴩʟʏ ᴛᴏ ᴀ ᴜsᴇʀ] : ɪsᴛɪғᴀᴅəçɪɴɪɴ ʙʟᴏᴋᴜɴᴜ ᴀç
/blockedusers : ʙʟᴏᴋʟᴀɴᴍɪş ɪsᴛɪғᴀᴅəçɪlərə ʙᴀx
"""
